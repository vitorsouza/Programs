	...
	private static void extractDates(File photoFile) throws Exception {
		...
		if (metadata == null) {
			...
			if (directory == null) {
				...
				if (directory.containsTag(ExifDirectory.TAG_DATETIME_DIGITIZED)) originalDate = directory.getDate(ExifDirectory.TAG_DATETIME_DIGITIZED);
				if (directory.containsTag(ExifDirectory.TAG_DATETIME_ORIGINAL)) digitizedDate = directory.getDate(ExifDirectory.TAG_DATETIME_ORIGINAL);
			}
		}
